...
static u_char ngx_http_server_string[] = "Server: somnium" CRLF;
static u_char ngx_http_server_full_string[] = "Server: " SOMNIUM_VER CRLF;
static u_char ngx_http_server_build_string[] = "Server: " SOMNIUM_VER_BUILD CRLF;
